...
const RegistrationForm = (props) => {
    ...
    const { onSubmitProp, errors, initialFirstName, initialLastName, initialEmail, btnTxt, disablePwd } = props
        ...
        <form onSubmit={ onSubmitHandler }>
            <div className="row my-3">
                ...
                <div className="col-sm-4">
                    <input type="text" className="form-control" id="firstName" value={ firstName } onChange={(e)=>setFirstName(e.target.value)}></input>
                </div>
            ...
            <div className="row">
                ...
                <div className="col-auto">
                    <button className="btn btn-outline-light btn-lg px-4 me-4" type="submit">{ btnTxt }</button>
                    { disablePwd ? 
                    null : 
